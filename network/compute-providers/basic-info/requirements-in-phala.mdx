...
The following are the requirements for workers on Phala Network.
...
> If you have a batch of workers that need to run on Phala, please visit here for more [information](/network/compute-providers/run-workers-on-phala/prbv3-deployment).
