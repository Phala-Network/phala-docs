---
description: Understand how compute providers earn PHA rewards through the Gemini
  tokenomics system.
title: Gemini Tokenomics (Worker Rewards)
---
...
To read about how Demand-end users can stake PHA to use the network, see [Stake to Compute](/network/compute-providers/basic-info/staking-mechanism).
