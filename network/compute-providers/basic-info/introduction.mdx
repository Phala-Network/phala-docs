...
We highly recommend computing power providers to first read about [Phala’s tokenomics ](/network/compute-providers/basic-info/worker-rewards)and [staking mechanism](/network/compute-providers/basic-info/staking-mechanism) to understand the calculation of incomings and how the compute supplying proceeds.

Anyone with the appropriate hardware can participate.

> More information about hardware requirements: 👉 [here](/network/compute-providers/basic-info/requirements-in-phala-khala)
