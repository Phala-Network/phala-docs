...
* [🔨 Build](ai-agent-contract/build/README.md)
  ...
  * [Use Default Agent DAO](ai-agent-contract/build/use-default-agent-dao.md)
  * [Customize Your Agent DAO](ai-agent-contract/build/customize-your-agent-dao.md)
* [🚀 Launch](ai-agent-contract/launch/README.md)
  * [Publish Agent Script](ai-agent-contract/launch/publish-agent-script.md)
  * [Deploy Agent DAO](ai-agent-contract/launch/deploy-agent-dao.md)
  * [Subscribe for Cross-Agent Usage](ai-agent-contract/launch/subscribe-for-cross-agent-usage.md)
...
* [🤝 Profit with Agent Wars](ai-agent-contract/profit-with-agent-wars.md)
* [🧙‍♂️ Examples](ai-agent-contract/examples/README.md)
  ...
  * [Connect from FLock.io Plugin](ai-agent-contract/examples/connect-from-flock.io-plugin.md)
  ...
  * [Connect from Fetch.ai Plugin](ai-agent-contract/examples/connect-from-fetch.ai-plugin.md)
  * [Handling Secrets and Queries](ai-agent-contract/examples/handling-secrets-and-queries.md)
