---
description: Run Large Language Models securely in GPU Trusted Execution Environment
  (TEE) for confidential AI.
title: GPU TEE
---
...
1. [**Host LLM in GPU TEE**](/confidential-ai/gpu-tee/llm-in-tee).
2. [**GPU TEE Inference API**](/confidential-ai/gpu-tee/inference-api)
3. [**Benchmark of running LLM in TEE**](/confidential-ai/gpu-tee/benchmark).
