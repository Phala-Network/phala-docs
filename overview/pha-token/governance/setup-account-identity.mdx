...
description: Participate in Phala Network governance using PHA tokens and democratic
  processes.
title: Setting Up an Account Identity
---
...
1. To get started, head over to your [My Accounts](https://polkadot.js.org/apps/?rpc=wss%3A%2F%2Fphala.api.onfinality.io%2Fpublic-ws#/accounts) tab of Phala (Switch to "Phala Network" -> "Accounts").
...
You can use [polkadot.js/apps](https://polkadot.js.org/apps/?rpc=wss%3A%2F%2Fphala.api.onfinality.io%2Fpublic-ws#/chainstate/constants) again to verify this amount by querying the `identity.subAccountDeposit` constant.
