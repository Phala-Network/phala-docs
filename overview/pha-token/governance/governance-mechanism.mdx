...
> Go to the [Governance](/overview/pha-token/governance) section for more detailed tutorials on voting and Treasury application.
...
<Frame caption="Adaptive Quorum Biasing mechanism">
    <img src="https://wiki.polkadot.network/assets/images/adaptive-quorum-biasing-18c2e70b6b9d2c3abf563219b11974dc.png" alt="Adaptive Quorum Biasing mechanism" />
