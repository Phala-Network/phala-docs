...
> Before you start to understand Vault, please make sure you have a clear understanding of [how StakePool works](/overview/pha-token/delegation/delegate-to-stakepool#how-it-works)
...
The Share Price ([Click here to learn what’s Share](/overview/pha-token/delegation/whats-share)) in the pool will change with each reward or slash. Between the last two commission executions, the number of Share Price changes multiplied by the total value of Shares represents the sum of total rewards and Slash in the pool which was issued accumulatively during this period.
