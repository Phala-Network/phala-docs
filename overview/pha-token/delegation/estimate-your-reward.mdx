...
Vaults act in the same role as delegators when Vaults delegate to StakePool. But the Vault owner will charge an additional commission for the management of funds. Click to learn more about [Vault commission](/overview/pha-token/delegation/whats-vault#how-is-the-vault-owners-reward-calculated).
