...
**Vault is always a simpler and more friendly delegation method.** Click [here](/overview/pha-token/delegation/whats-vault) to learn more about Vault.
