...
> For the fundamentals of dstack remote attestation, the RA-TLS (Remote Attestation TLS) protocol design, and ZT-TLS / ACME certificate management, refer to the official Phala documentation:
>
...
**TDX Verification:**
1. Retrieve TDX collateral and verify quote signature using Intel's TCB (Trusted Computing Base) info
...
For platform-specific details, see the sections above. For a broader architectural comparison, see [AWS Nitro Enclave Integration](/dstack-cloud/nitro-enclave).
...
- **[Security Model](/dstack-cloud/security-model)** — Trust boundaries and security guarantees
