...
> The two platforms have different architectures. See [Nitro Enclave Integration](/dstack-cloud/nitro-enclave) for a detailed comparison.
...
| **Gateway** | Edge TLS termination, automatic ACME certificate provisioning, RA-TLS (Remote Attestation TLS) support |
...
- **[Nitro Enclave](/dstack-cloud/nitro-enclave)** — How AWS Nitro Enclaves work in dstack-cloud
- **[KMS and Key Delivery](/dstack-cloud/kms-and-key-delivery)** — Understand how keys are managed and delivered
- **[Security Model](/dstack-cloud/security-model)** — Trust boundaries and security guarantees
- **[Attestation Integration](/dstack-cloud/attestation-integration)** — How remote attestation works across platforms
