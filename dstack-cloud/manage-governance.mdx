...
- **[Register Workload Measurements](/dstack-cloud/register-enclave-measurement)** — Most common governance action
- **[Deploy On-chain KMS Smart Contracts](/dstack-cloud/deploy-onchain-kms)** — Initial contract setup
