...
The dstack ecosystem has two distinct registration flows:

| Registration Type | What Gets Registered | Purpose | Where to Find |
|-------------------|---------------------|---------|---------------|
| **KMS Registration** | KMS's `mrAggregated` (GCP) or public key | Proves KMS runs in a genuine TEE | [Run dstack-kms on GCP](/dstack-cloud/run-kms-on-gcp) Step 8 |
...
- **[Manage Governance](/dstack-cloud/manage-governance)** — Other governance operations
