...
- **[Register KMS Measurements](/dstack-cloud/run-kms-on-gcp)** — Register KMS measurements before bootstrap
- **[Register Workload Measurements](/dstack-cloud/register-enclave-measurement)** — Authorize workloads to receive keys
