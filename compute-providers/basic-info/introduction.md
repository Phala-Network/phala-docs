...
As introduced in the [Gemini Tokenomics](worker-rewards.md), computing power providers can choose to provide their workers on the Phala and Khala networks.
...
We highly recommend computing power providers to first read about [Phala’s tokenomics ](worker-rewards.md)and [staking mechanism](staking-mechanism.md) to understand the calculation of incomings and how the compute supplying proceeds.
