...
title: Installing Khala Solo Scripts
---
...
> ℹ You may have already enabled the Intel® SGX Extensions during your hardware setup in the previous section. Skip and proceed to 👉[Install Phala Tools](#install-phala-tools) if already activated.
