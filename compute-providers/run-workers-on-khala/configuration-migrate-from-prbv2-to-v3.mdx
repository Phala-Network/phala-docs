...
First, we should create a clean PRBv3 deployment by referring to this page: [PRBv3 Deployment Guide](/compute-providers/run-workers-on-phala/prbv3-deployment)
