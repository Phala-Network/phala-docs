...
If you still have issues attempt to [update the script](/compute-providers/run-workers-on-khala/solo-scripts-guidance/update-your-workers-node).
...
You can [follow this tutorial](/compute-providers/run-workers-on-khala) to redownload and reinstall the new phala mining scripts.
