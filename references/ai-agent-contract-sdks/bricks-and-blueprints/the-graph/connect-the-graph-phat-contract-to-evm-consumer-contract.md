...
If you have not setup The Graph code repo locally, go back to the [Quick Start](broken-reference) section and follow the initial setup steps.
...
> * `apiKey` - an [API key created](broken-reference) on The Graph
>
> ```
> {
