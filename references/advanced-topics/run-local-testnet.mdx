...
We have a client-side application at [https://phat.phala.network/](https://phat.phala.network/), you can follow the instructions from [Phat Contract Console](../../images/awesome%20phat%20contracts%20\(2\)/) to connect the application to the local testnet.
