...
The Dstack SDK is designed to simplify the steps for developers to deploy programs to CVM (Confidential VM), and to follow the security best practices by default. Explore [dstack's blockchain-verified computing](https://phala.com/dstack) capabilities and architecture. The main features include:
