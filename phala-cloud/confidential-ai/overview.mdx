...
Here are two products, Confidential AI API and Confidential AI Models.

[Confidential AI API](/phala-cloud/confidential-ai/confidential-model/confidential-ai-api) provides a pre-deployed LLM inference service with an OpenAI-compatible interface, making it easy to integrate into your applications. 

And [Confidential AI Models](/phala-cloud/confidential-ai/confidential-model/confidential-ai-models) enables you to deploy and manage your own AI models in GPU TEE.

### Confidential GPU

If you want to deploy custom model with complete control over your infrastructure, check [Confidential GPU](/phala-cloud/confidential-ai/confidential-gpu/overview) to depoy with various GPU configurations, configure CPU, RAM, and storage to match your workload requirements based on your needs.
