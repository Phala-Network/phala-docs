---
description: Use Confidential AI through an OpenAI-compatible API or custom GPU TEE infrastructure, with attestation reports and signed receipts you can verify.
title: Overview
---
...
Phala Cloud offers pre-deployed **Models** through an API for quick integration, and **GPU TEE** for custom infrastructure. See [available models](https://phala.com/confidential-ai-models) for supported models, use cases, and deployment options.
...
- **Flexible deployment**: Choose from API access (pay per request) or GPU TEE (full infrastructure control)
