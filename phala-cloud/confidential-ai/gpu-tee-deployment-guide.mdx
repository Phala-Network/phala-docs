...
For pre-deployed models that don't require infrastructure setup, use the [On-demand API](/phala-cloud/confidential-ai/confidential-model/confidential-ai-api) instead.
...
| B300 | 288 GB | Largest models, maximum throughput |
...
<CardGroup cols={2}>
  ...
  >
    Confirm inference responses are authentic using signed receipts
  </Card>
