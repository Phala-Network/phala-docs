...
curl -H "Authorization: Bearer sk-your-api-key" \
  "https://<base_url>/v1/aci/attestation?nonce=$NONCE"

# Get the signed receipt for a chat completion
curl -H "Authorization: Bearer sk-your-api-key" \
  "https://<base_url>/v1/aci/receipts/{receipt_id_or_chat_completion_id}"
```

See [Verify Attestation](/phala-cloud/confidential-ai/verify/verify-attestation) and [Verify a Response](/phala-cloud/confidential-ai/verify/verify-signature) for how to use these endpoints to confirm your requests were processed inside a TEE.
