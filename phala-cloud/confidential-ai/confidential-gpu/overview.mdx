...
Check the Price section to confirm your hardware specs and cost. Click **Submit Order** to submit order.

<Frame caption="Review & Submit Order">
  <img src="/images/confidential-ai/confidential-gpu/gpu-tee-02.png" />
</Frame>

Once successfully submitted, the Phala Cloud team will received the request and will contact you soon.
