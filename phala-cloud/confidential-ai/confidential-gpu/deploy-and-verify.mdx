...
Each instance includes NVIDIA Driver `570.133.20` and CUDA `12.8`. Each instance comes with 1 or 8 GPUs.
...
|----------|--------|-----------|------|-----|---------|--------|
| H200 (1 GPU) | US | 24 | 141 GB | 192 GB | 1 TB | $4.80/hour |
| H200 (8 GPUs) | US | 192 | 1128 GB | 1536 GB | 1 TB | from $28.00/hour |

\*On-demand rate for the 1-GPU option; the 8-GPU option starts at the 6-month commitment rate. Check the dashboard for current rates and commitment pricing.
...
| Plan | Rate | Notes |
|------|------|-------|
| 6-month commitment | $3.80/GPU/hour | Lowest rate, long-term commitment |
| 1-month commitment | $4.30/GPU/hour | Short-term commitment |
| On-Demand | $4.80/GPU/hour | Pay-as-you-go, no commitment |

Rates shown are for a single H200 in the US region. Review the **Pricing Summary** showing estimated costs per hour, day, and month.
...
Look for your GPU model (H200/B300), driver version 570.133.20, and CUDA version 12.8. Then check confidential compute status:
