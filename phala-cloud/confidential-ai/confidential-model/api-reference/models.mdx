...
Use the live model catalog before hardcoding model IDs. The catalog returns model IDs, context windows, pricing, providers, modalities, supported parameters, and whether a model can be served confidentially.
