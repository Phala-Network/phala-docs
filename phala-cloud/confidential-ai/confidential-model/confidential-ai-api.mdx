...
The following table reflects the current model families in the live model catalog. Pricing and availability can change; use the API response for production routing.
