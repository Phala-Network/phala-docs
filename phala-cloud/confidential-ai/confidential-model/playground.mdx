...
3. In Connection settings page, click setting icon to fill in the `URL` with `https://inference.phala.com/v1`, input Bearer token with your API key, and then click `Save` button.
