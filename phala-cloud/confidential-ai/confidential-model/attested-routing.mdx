...
```bash
curl -s "https://inference.phala.com/v1/aci/sessions?model=phala/qwen3.6-35b-a3b-uncensored" \
  -H "Authorization: Bearer <API_KEY>" \
...
{
  "error": {
    "message": "upstream verification failed: none of the requested attested sessions is available for model phala/qwen3.6-35b-a3b-uncensored",
    "type": "service_unavailable"
  }
}
```
...
```json
{
  ...
  "upstream_name": "phala-86",
  "provider_type": "phala-direct",
  "model_id": "phala/qwen3.6-35b-a3b-uncensored",
  "url_origin": "https://qwen3-6-35b-a3b-uncensored.use1.phala.com",
  "verifier_id": "private-ai-verifier/phala-direct/v1",
  "result": "verified",
  "required": true,
  "session_id": "as_941d3d5f...",
  "channel_bindings": [{"type": "tls_spki_sha256", "origin": "https://qwen3-6-35b-a3b-uncensored.use1.phala.com", "spki_sha256": "4088be15..."}],
