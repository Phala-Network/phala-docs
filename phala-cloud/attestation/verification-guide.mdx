...
description: Practical guide to fetching, verifying, and integrating CVM attestation into your workflow
---
...
Every CVM attestation verification follows three steps: get a quote from your running CVM, verify the quote's hardware signature, and check that the measurements match your expected application. The entire process takes seconds and can run from anywhere outside the CVM.
...
You can also paste your quote into the [TEE Proof Explorer](https://proof.t16z.com/) for an interactive visual breakdown of all quote fields.
