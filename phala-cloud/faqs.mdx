...
Check the [pricing page](https://cloud.phala.com/about/pricing) for more details.

**Quick summary:**
- **Compute**: Billed per-minute based on instance type (only while running)
- **Storage**: $0.000139/GB/hour (~$0.10/GB/month) - charged even when stopped
- **GPU TEE**: Billed hourly with 24-hour minimum for on-demand
