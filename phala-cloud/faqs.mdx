...
Or set CI/CD pipeline for you instance: https://phala.com/phala-cloud/be-production-ready/ci-cd-automation/setup-a-ci-cd-pipeline
...
We have built a Phala cloud cli so you don't need to touch the raw docker command. The doc is available here: https://phala.com/phala-cloud/references/tee-cloud-cli/phala/simulator.
...
article](https://phala.com/posts/how-to-generate-attestation-repport-and-prove-your-application-runs-in-tee) for more details.
...
The tech stack has moved to **dstack**-based infrastructure. See the [announcement](https://x.com/PhalaNetwork/status/1988085610649973070) for details.

For new projects, use:
- [Phala Cloud CVMs](/phala-cloud/what-is/phala-cloud-overview) for TEE deployments
- [dstack](/dstack/overview/what-is-dstack) for the underlying TEE infrastructure
