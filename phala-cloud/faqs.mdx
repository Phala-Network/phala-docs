...
- [Cloud API docs](https://cloud-api.phala.network/docs)
- [API examples (JavaScript)](https://github.com/Leechael/phala-cloud-api-example/tree/main/js)
...
- **Minimum charge**: $84 upfront for the first 24 hours
...
- Usage beyond 24 hours is billed hourly
...
You can also use the [Phala Cloud API](https://cloud-api.phala.network/docs) for custom automation.
