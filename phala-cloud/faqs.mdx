...
Check the [pricing page](/phala-cloud/pricing) for more details.
...
**GPU TEE:** Billed by hours with a 24-hour minimum. See [GPU TEE Billing](/phala-cloud/pricing#gpu-tee-billing-rules) for details.
