...
<Update label="December 15-19, 2025" tags={["GPU", "Billing", "ClickHouse"]} rss={{ title: "GPU Lifecycle & ClickHouse Improvements", description: "Enhanced GPU allocation lifecycle, ClickHouse migrations, and billing refinements" }}>
...
<Update label="December 1-14, 2025" tags={["Usage", "Workspace", "Security"]} rss={{ title: "Usage Export & Workspace Validation", description: "Usage data export, workspace slug validation, and security improvements" }}>
