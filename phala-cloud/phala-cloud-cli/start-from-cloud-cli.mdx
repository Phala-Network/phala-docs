...
<Frame caption="Signup Page">
    <img src="/images/signup-page.png" alt="Phala Cloud registration page with sign up form" />
...
<Frame>
    <img src="/images/dashboard-logo-highlight.png" alt="Phala Cloud dashboard with logo highlighted in top left corner" />
</Frame>

Click your username and select "**API Tokens**".

<Frame>
    <img src="/images/api-tokens-menu.png" alt="User dropdown menu with API Tokens option highlighted" />
</Frame>

Click Create Token and then copy your newly generated API Key.

<Frame>
    <img src="/images/api-token-creation.png" alt="API token creation interface with newly generated token displayed" />
</Frame>
