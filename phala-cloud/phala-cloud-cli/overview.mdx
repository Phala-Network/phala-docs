...
The CLI communicates with the Phala Cloud API using header-based versioning. The current default API version is `2026-06-23`.
...
|---------|--------|
| `2026-06-23` | Default |
| `2026-05-22` | Supported |
| `2026-01-21` | Supported |
| `2025-10-28` | Legacy |
...
| Command | Description |
|---------|-------------|
| [`allow-devices`](/phala-cloud/phala-cloud-cli/allow-devices) | Manage an app contract's device allowlist |
| [`api`](/phala-cloud/phala-cloud-cli/api) | Make authenticated API requests |
| [`keccak256sum`](/phala-cloud/phala-cloud-cli/keccak256sum) | Compute or verify Keccak-256 checksums |
| [`kms`](/phala-cloud/phala-cloud-cli/kms) | List KMS contracts and inspect their nodes |
...
These commands remain available for compatibility but have newer replacements.
...
| `--api-version <version>` | Override the API version, including `2026-06-23`, `2026-05-22`, `2026-01-21`, and `2025-10-28` |
| `--timeout <seconds>` | Set the API request timeout in seconds; the default is 60 |
