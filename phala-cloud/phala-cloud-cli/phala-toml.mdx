...
Create `phala.toml` manually in your project root. The current CLI reads this file but does not generate it for you.
...
**File not found** — Create `phala.toml` in your project root or ensure you're in the correct directory.
