...
**Solutions:**
1. Check your [account tier limits](https://cloud.phala.com/about/pricing)
...
- Use [TCP port forwarding](/phala-cloud/networking/expose-http-service) with TLS wrapping
- See the [TCP services guide](/phala-cloud/networking/expose-tcp-service)
...
See [GPU TEE Billing](/phala-cloud/faqs#how-does-gpu-tee-billing-work) for details on:
- Minimum rental period charges
