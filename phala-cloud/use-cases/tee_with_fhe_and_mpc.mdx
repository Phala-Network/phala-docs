...
title: TEE as 2FA for FHE/MPC Systems
icon: "lock"
---
...
- MPC nodes build a docker image and deploy it to [Phala Cloud](https://cloud.phala.network/register?invite=PHALAWIKI), see the [tutorial](/phala-cloud/phala-cloud-user-guides/create-cvm/create-with-docker-compose).
