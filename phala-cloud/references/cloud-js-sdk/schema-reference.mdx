...
The `@phala/cloud` SDK uses [Zod](https://zod.dev) schemas for runtime validation of all API responses. API version `2026-06-23` is the default. Its CVM and app endpoints use the `V20260522` schemas, while its KMS endpoints use the contract-centric schemas documented on the [KMS page](/phala-cloud/references/cloud-js-sdk/kms).
