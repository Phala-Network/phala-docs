...
The [Phala Cloud CLI](/phala-cloud/references/phala-cloud-cli/phala/overview) (`phala`) is your primary tool for managing deployments and interacting with the platform from the command line.
