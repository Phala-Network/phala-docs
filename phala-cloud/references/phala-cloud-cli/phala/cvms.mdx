...
- **`cvms create`** — Use [`phala deploy`](/phala-cloud/references/phala-cloud-cli/phala/deploy) instead
- **`cvms upgrade`** — Use [`phala deploy --cvm-id <id>`](/phala-cloud/references/phala-cloud-cli/phala/deploy) instead
- **`cvms logs`** — Use [`phala logs`](/phala-cloud/references/phala-cloud-cli/phala/logs) instead
- **`cvms serial-logs`** — Use [`phala logs --serial`](/phala-cloud/references/phala-cloud-cli/phala/logs) instead
