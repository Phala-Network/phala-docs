...
- A running CVM on Phala Cloud
- Understanding of your application's resource requirements

## Dynamic Resource Allocation

Phala Cloud provides flexible compute resource management, allowing you to scale your application's resources up or down based on your needs.
