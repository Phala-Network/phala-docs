...
| GPU Model | Commitment | Price | Notes |
|-----------|------------|-------|-------|
| **NVIDIA H200** | On-Demand | $3.50/hour | 24-hour minimum |
| **NVIDIA H200** | 1-Month | $2.56/hour | Monthly commitment |
| **NVIDIA H200** | 6-Month | $2.30/hour | Best value |
| **NVIDIA B200** | On-Demand | $3.80/hour | 24-hour minimum |
...
**On-Demand GPU TEE:**
- **Minimum charge**: When you start an instance, you are charged **$84 upfront for the first 24 hours** (H200)
...
- Usage beyond 24 hours is billed hourly (pay-as-you-go)
- If you stop and restart later, the 24-hour minimum applies again

**Commitment Plans:**
- Lower hourly rates with monthly or 6-month commitments
- Contact cloud@phala.network for commitment pricing

### GPU Configuration

- Available GPUs per instance: 1, 2, 4, or 8 GPUs
- Multi-GPU pricing scales linearly (e.g., 2x H200 = 2x hourly rate)
