...
If you can access the service, it means you've successfully deployed your existing Docker application into a **TEE**. Next step is to [**generate a RA report**](/phala-cloud/networking/generate-ra-report) to prove the integrity of your application.
