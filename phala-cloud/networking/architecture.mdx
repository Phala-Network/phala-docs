---
title: Network Architecture Deep Dive
description: Understanding how Phala Cloud routes and secures your network traffic
---

Understanding how Phala Cloud routes and secures your network traffic helps you design better applications and troubleshoot issues effectively.

## Request Journey

When a client connects to `abc123-8080.us.phala.network`, the request follows a specific path that affects both security and performance.
...
services:
  gateway:
    ports: ["443:443"]
    environment:
      BACKEND_1: https://abc123-8080.us.phala.network
      BACKEND_2: https://def456-8080.us.phala.network
```
