...
<Frame>
    <img src="/images/image (21).png" alt="Browser showing /evidences/ directory listing with four files: acme-account.json, cert.pem, quote.json, and sha256sum.txt with timestamps and file sizes" />
</Frame>
