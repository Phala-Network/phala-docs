...
<Frame>
    <img src="/images/evidence-files-directory.png" alt="Browser showing /evidences/ directory listing with four files: acme-account.json, cert.pem, quote.json, and sha256sum.txt with timestamps and file sizes" />
</Frame>
...
Learn more: [Application Attestation Documentation](/phala-cloud/attestation/overview)
...
For detailed application verification: [Attestation Guide](/phala-cloud/attestation/overview)
</Note>
