...
description: Phala Cloud provides secure TEE-powered infrastructure for running AI applications with hardware-level privacy and verifiable execution.
icon: cloud
image: /images/phala-docs-preview-v2.png
---

Phala Cloud is a confidential computing platform for running AI applications with hardware-level privacy. Deploy any standard Docker application directly into a **TEE** — your AI models and data remain confidential and tamper-proof.
...
Compare Phala Cloud to other confidential computing platforms: [Phala vs AWS Nitro](https://phala.com/compare/phala-vs-aws-nitro), [Phala vs Google Cloud](https://phala.com/compare/phala-vs-gcp), and [Phala vs Tinfoil](https://phala.com/compare/phala-vs-tinfoil).
