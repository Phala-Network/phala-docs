...
If you still got `Login attempt failed` error, considering login your X account with browser and logout the old session. See related [issue](https://github.com/elizaOS/eliza/issues/905) on Eliza repo.
