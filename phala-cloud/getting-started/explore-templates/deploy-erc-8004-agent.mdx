...
![Network Details](./images/erc-8004-agent/network-details.jpg)
...
![VibeVM Login](./images/erc-8004-agent/vibevm-login.jpg)
...
![Environment Configuration](./images/erc-8004-agent/env-configuration.jpg)
...
![Agent Running](./images/erc-8004-agent/agent-running.jpg)
...
![Agent Registration](./images/erc-8004-agent/agent-registration.jpg)

![Registration Transaction](./images/erc-8004-agent/registration-transaction.jpg)
...
![TEERegistry Verification](./images/erc-8004-agent/tee-registry-verification.jpg)
