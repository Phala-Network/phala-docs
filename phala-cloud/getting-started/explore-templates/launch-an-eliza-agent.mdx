...
Phala Cloud has introduced a new feature that allows users to deploy an [Eliza agent](https://www.elizaos.ai/) without any coding. You can access this feature through [cloud.phala.network/eliza](https://cloud.phala.network/eliza). Learn how [private AI agents](https://phala.com/solutions/ai-agents) protect user privacy and maintain autonomy in decentralized environments. **In this tutorial, we'll guide you through the process of deploying an agent named Trump, capable of tweeting in his distinctive tone**.
...
Besides setting user name, password, and email with specific environments, you also need to enable 2FA on your X account and set it through `TWITTER_2FA_SECRET`. Check the [tutorial](https://phala.com/posts/guide-to-exploring-the-phala-cloud-agent-builder) for more information. 
