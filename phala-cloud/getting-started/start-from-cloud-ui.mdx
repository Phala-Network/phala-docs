...
2.  Paste the config file to describe your service in docker compose format as **compose.yml**. In this tutorial, we deploy a basic jupyter-notebook without any code change.
