...
2. **Build an AI agent** in minutes and deploy in one-click with the [Eliza Agent Builder](https://cloud.phala.network/eliza) - check out the [tutorial](https://phala.com/posts/guide-to-exploring-the-phala-cloud-agent-builder) to get started
